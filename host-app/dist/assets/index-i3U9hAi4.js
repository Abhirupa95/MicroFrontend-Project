...
const moduleMap = {'react':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-Bfaz99l3.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import$1(new URL('__federation_shared_react-dom-C8HiEUq4.js', import.meta.url).href),import:true}};
...
const remotesMap = {
'todo_components':{url:'http://localhost:4173/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    'react':{'19.0.0':{get:()=>get(new URL('__federation_shared_react-Bfaz99l3.js', import.meta.url).href), loaded:1}},'react-dom':{'19.0.0':{get:()=>get(new URL('__federation_shared_react-dom-C8HiEUq4.js', import.meta.url).href), loaded:1}}
...
const __federation_var_todo_componentsList = await __federation_method_getRemote("todo_components" , "./List");
 let List = __federation_method_unwrapDefault(__federation_var_todo_componentsList); 
const __federation_var_todo_componentsInput = await __federation_method_getRemote("todo_components" , "./Input");
 let Input = __federation_method_unwrapDefault(__federation_var_todo_componentsInput); 
const __federation_var_todo_componentsButton = await __federation_method_getRemote("todo_components" , "./Button");
 let Button = __federation_method_unwrapDefault(__federation_var_todo_componentsButton); 
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { onSubmit: handleSubmit }),
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(List, { items: todos }),
